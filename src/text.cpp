...
std::map<GLchar, stbtt_char_t> stbtt_char_list_2;
std::map<GLchar, stbtt_char_t> stbtt_char_list_3;
std::map<GLchar, stbtt_char_t> stbtt_char_list_4;
std::map<GLchar, stbtt_char_t> font_list[4];
char* font_path_list[4];


void create_font_textures(int fontID)
{
	...
	{	
		...
		font_list[fontID].insert(std::pair<GLchar, stbtt_char_t>(c, character));
	}

	printf( "Font textures created well using stb_truetype\n\n" );
}

void text_init(int fontID)
{
	char* font_path;
	font_path = font_path_list[fontID];
...
void text_initialize() {
	font_list[0] = stbtt_char_list;
	font_list[1] = stbtt_char_list_2;
	font_list[2] = stbtt_char_list_3;
	font_list[3] = stbtt_char_list_4;
	font_path_list[0] = "../bin/fonts/lunasol aurora.ttf";
	font_path_list[1] = "../bin/fonts/lunasol eclipse.ttf";
	font_path_list[2] = "../bin/fonts/lunasol regular.ttf";
	font_path_list[3] = "../bin/fonts/Play-Regular.ttf";
	for (int i = 0; i < 4; i++) {
		text_init(i);
	}
}
